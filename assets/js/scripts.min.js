...
! function(e) {
    ...
    e(function() {
        ...
        e("#off-canvas-layer").on("click", function(e) {
            ...
            function() {
                n.find(".menu .menu-item-has-children ").prepend('<span class="toggle-children "><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> '), n.find(".menu .menu-item-has-children").each(function() {
                    var i = "";
                ...
                }), n.find(".menu .menu-item-has-children").on("click", ".touch_click", function(i) {
